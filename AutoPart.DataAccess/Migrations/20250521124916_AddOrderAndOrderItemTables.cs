        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalSumBGN = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    TotalSumEuro = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SubtotalBGN = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    SubtotalEuro = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    Status = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrderItems_PartsInStock_PartId",
                        column: x => x.PartId,
